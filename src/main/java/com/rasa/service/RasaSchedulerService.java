...
import com.rasa.models.Data;
import com.rasa.models.Message;
import com.rasa.models.RasaNluData;
import com.rasa.models.TrainRequest;

@Service
public class RasaSchedulerService {
	private static final Logger LOGGER = LoggerFactory.getLogger(RasaSchedulerService.class);
